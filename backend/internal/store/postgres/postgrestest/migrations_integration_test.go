...
func TestMigrationsUpDownUp(t *testing.T) {
	...
	assertMigrationResults(t, firstUp, []migrationResultWant{{version: 1, direction: "up"}, {version: 2, direction: "up"}, {version: 3, direction: "up"}, {version: 4, direction: "up"}, {version: 5, direction: "up"}, {version: 6, direction: "up"}, {version: 7, direction: "up"}, {version: 8, direction: "up"}})
	assertMigrationStates(t, ctx, database.DB, map[int64]string{1: "applied", 2: "applied", 3: "applied", 4: "applied", 5: "applied", 6: "applied", 7: "applied", 8: "applied"})
	...
	assertMigrationResults(t, down, []migrationResultWant{{version: 8, direction: "down"}})
	assertMigrationStates(t, ctx, database.DB, map[int64]string{1: "applied", 2: "applied", 3: "applied", 4: "applied", 5: "applied", 6: "applied", 7: "applied", 8: "pending"})
	assertTableExists(t, ctx, database.DB, "sync_state", true)
	assertTableExists(t, ctx, database.DB, "indexed_blocks", true)
	assertTableExists(t, ctx, database.DB, "token_launches", true)
	assertTableExists(t, ctx, database.DB, "tokens", true)
	...
	assertMigrationResults(t, secondUp, []migrationResultWant{{version: 8, direction: "up"}})
	assertMigrationStates(t, ctx, database.DB, map[int64]string{1: "applied", 2: "applied", 3: "applied", 4: "applied", 5: "applied", 6: "applied", 7: "applied", 8: "applied"})
	assertTableExists(t, ctx, database.DB, "sync_state", true)
	assertTableExists(t, ctx, database.DB, "indexed_blocks", true)
	assertTableExists(t, ctx, database.DB, "token_launches", true)
