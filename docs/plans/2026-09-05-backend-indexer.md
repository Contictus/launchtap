...
hardening. Task 1 gates production operation: if the active provider cannot supply a usable
`safe` tag, that is a launch blocker, not a runtime patch (`backlog.md`, spec §4.1).
